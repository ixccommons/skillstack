#!/usr/bin/env python3
"""Build dist/marketing-workshop.zip — the whole skill, zipped for platforms
...
upload dialog, which reads a .zip/.skill file or a bare SKILL.md).
    ...
    python3 marketing-workshop/scripts/build_skill_zip.py          # write dist/
...
change under marketing-workshop/ (other than dist/ itself) and commit the
